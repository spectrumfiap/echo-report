    ...
    <div className="container mx-auto px-6 py-12">
      ...
      {noticeState !== 'hidden' && (
        ...
        >
          ...
          <span>
            Estamos utilizando serviços de hospedagem gratuitos para nossa API. O carregamento das informações do mapa pode levar alguns bons segundos. Agradecemos a sua paciência!
          </span>
        </div>
      )}
