...
import Image from 'next/image'; // Image foi usado nos cards de Quem Somos, pode ser útil aqui também se os ícones forem complexos ou externos
...
import {
  ...
  MapIcon // MapIcon não está sendo usado, pode remover se não for necessário
      ...
      >
        {managementSections.map((section) => {
          ...
          return (
            ...
            >
              <div className="flex flex-col items-center text-center h-full"> {/* Adicionado h-full para consistência de altura */}
                ...
                <p className="text-sm text-[var(--brand-text-secondary)] mt-2 px-2 flex-grow"> {/* Adicionado flex-grow para empurrar o conteúdo para baixo se as descrições tiverem tamanhos diferentes */}
                  {section.description}
                </p>
              </div>
            </Link>
